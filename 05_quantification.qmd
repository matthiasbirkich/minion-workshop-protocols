...
This relationship is specific to a fragment close to 726 bp and must
not be used as a general conversion factor for SHARK-Seq products.
...
with amplicon length. A current reagent blank should therefore always
be measured for quantitative work.
